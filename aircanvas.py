...
while True:
    ...
    frame = cv2.rectangle(frame, (20, 70), (60, 110), (255, 255, 255), -1)
    frame = cv2.rectangle(frame, (20, 120), (60, 160), (0, 0, 0), -1)
    frame = cv2.rectangle(frame, (20, 170), (60, 210), (255, 0, 0), -1)
    frame = cv2.rectangle(frame, (20, 220), (60, 260), (0, 255, 0), -1)
    frame = cv2.rectangle(frame, (20, 270), (60, 310), (0, 0, 255), -1)
    ...
    # Border for Recognise button
    cv2.rectangle(frame, (520, 1), (630, 65), (0, 0, 0), 2)
    ...
    if len(lmList) != 0 and totalFingers == 1:
        ...
        if center[0] <= 60:
            ...
            output_text = det.predict("new.jpg")
